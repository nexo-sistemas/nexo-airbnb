    ...
    init(params) {
        ...
        this.eGui.innerHTML = `
            <div class="d-flex justify-content-center">
                ...
                <a href="https://api.whatsapp.com/send?phone=${params.data.celular}&text=Hola,%0Ale comparto el link del formulario de Airbnb,%0Adonde podrá ingresar los datos de su Huésped.%0A%0A%0A${URLAPP}/login-propietario?u=${params.data.uuid}" target="_blank"
